    ...
    return (
        <div>
            ...
            <div class="container privacy_container">
                ...
                <div>
                    <p><strong>Effective date:</strong> August 30, 2018</p>
                </div>
                <div>
                    <p>Rework Technologies ("us", "we", or "our") operates the website and the Kitchly mobile application (the
                        "Service").</p>
                </div>
                <div>
                ...
                <div>
                    <p>Rework Technologies uses the collected data for various purposes:</p>
                </div>
                <div>
                    <ul>
                ...
                <div>
                    <p>If you are located outside Nigeria and choose to provide information to us, please note that we transfer
                        the data, including Personal Data, to Nigeria and process it there.</p>
                </div>
                <div>
                ...
                <div>
                    <p>Rework Technologies will take all steps reasonably necessary to ensure that your data is treated securely
                ...
                <div>
                    <p>Rework Technologies may disclose your Personal Data in the good faith belief that such action is
                        necessary to:</p>
                </div>
                <div>
                    <ul>
                        <li>To comply with a legal obligation</li>
                        <li>To protect and defend the rights or property of Rework Technologies</li>
                ...
                <div>
                    <ul>
                        <li>By email: app.reworktechnologies@gmail.com</li>
                        <li>By visiting this page on our website: reworktechnologies</li>
                    </ul>
                </div>
            </div>
            <br />
